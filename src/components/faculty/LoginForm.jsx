...
const LoginForm = () => {
  ...
  // Removed the showToast function, as it was using alert.
  // In a real application, you would integrate a proper toast notification system here.
  ...
  const handleLogin = async (e) => {
    ...
    setTimeout(() => {
      if (facultyId && password) {
        // showToast("Login successful!"); // Removed alert
        navigate('/faculty-dashboard');
      } else {
        // showToast("Please enter Faculty ID and Password"); // Removed alert
      }
      setIsLoading(false);
    }, 1500);
  };
